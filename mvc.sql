...
CREATE TABLE `Product` (
  ...
  FULLTEXT KEY `products` (`productName`,`productDescription`)
...
INSERT INTO `Product` VALUES (1,'Teste','Testando',10.00,'/img/product.jpg'),(2,'Produto','Outro Teste',50.00,'/img/product.jpg');
...
-- Dump completed on 2011-08-17 17:06:09
